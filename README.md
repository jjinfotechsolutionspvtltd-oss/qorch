...
```bash
pip install -e ".[dev]" && python -m pytest      # 1046 tests, ~40s, no services required
```
...
- **Correct by construction** — immutable IR, 1046 tests, mypy-clean, with property and cross-simulator validation.
...
tests/                   # 1046 unit tests (~95% coverage)
```
